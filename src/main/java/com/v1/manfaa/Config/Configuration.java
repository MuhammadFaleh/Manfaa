    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/v1/service-request/update/**", "/api/v1/service-request/delete/**", "/api/v1/service-request/get-with-bids/**","/api/v1/service-request/get-my-requests").hasAuthority("COMPANY")
                        ...
                        .requestMatchers("/api/v1/service-bid/create/**", "/api/v1/service-bid/get-my-bids","/api/v1/service-bid/update/**", "/api/v1/service-bid/delete/**", "/api/v1/service-bid/accept/**", "/api/v1/service-bid/reject/**").hasAuthority("COMPANY")
